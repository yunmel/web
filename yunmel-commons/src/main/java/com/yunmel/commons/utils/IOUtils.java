...
public class IOUtils extends FileUtils {
   ...
   * @throws Exception
   */
  public static void zipDownLoad(Map<File, String> downQuene, HttpServletResponse response)
      throws IOException {
  ...
  private static void compressFolder(File dir, String fileName, ZipOutputStream zipout,
      String baseDir) {
    if (!dir.exists()) {
      return;
    }
  ...
  private static void compressFile(File file, String fileName, ZipOutputStream zipout,
      String baseDir) {
    try {
      ZipEntry entry = null;
      if (baseDir.equals("/")) {
